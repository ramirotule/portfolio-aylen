    ...
    <section id="contacto" className="py-24 bg-gradient-to-br from-slate-900 via-emerald-950 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-[1fr_1fr_auto] gap-4 mb-10"
        >
          {/* Email */}
          <a
            href={`mailto:${personalInfo.email}`}
            className="flex items-center gap-4 p-5 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-emerald-400/40 rounded-2xl transition-all duration-200 group"
          >
            ...
            <div>
              ...
              <p className="text-white text-sm font-medium break-all">{personalInfo.email}</p>
            </div>
          </a>
          ...
          <a
            ...
            className="flex items-center gap-4 p-5 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-blue-400/40 rounded-2xl transition-all duration-200 group"
          >
            ...
            <div>
              ...
              <p className="text-white text-sm font-medium">Ver perfil</p>
            </div>
          </a>
